...
public class Department
{
    ...
    // Constructor for initializing department with name and capacity
...
// Represents a student in the migration system
public class Student
{
    ...
    // Constructor to initialize the student with their name, rank, and department preferences
...
// Default migration strategy implementation
...
public class MigrationSystem
{
    ...
    // Constructor initializes the system with departments, students, and a chosen migration strategy
    ...
    // Method to run the migration process for a set number of calls (iterations)
...
// Entry point for the migration system
class Program
{
    static void Main()
    {
        ...
        var migrationSystem = new MigrationSystem(departments, students, new DefaultMigrationStrategy());
